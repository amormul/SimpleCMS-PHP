        ...
        <form method="POST">
            <div class="mb-3">
                ...
                <input type="text" class="form-control <?php echo !empty($data['errors']['title']) ? 'is-invalid' : ''; ?>" 
                       id="title" name="title" value="<?php echo htmlspecialchars($data['article']['title']); ?>" required>
            ...
            <div class="mb-3">
                ...
                <textarea class="form-control <?php echo !empty($data['errors']['content']) ? 'is-invalid' : ''; ?>" 
                          id="content" name="content" rows="10" required><?php echo htmlspecialchars($data['article']['content']); ?></textarea>
